;(function ($, window, document, undefined) {
    ...
    Owl.Workers = [{
        ...
        filter: ['width', 'items', 'settings'], run: function (cache) {
            var margin = this.settings.margin || '', grid = !this.settings.autoWidth, rtl = this.settings.rtl, css = {
                'width': 'auto', 'margin-left': rtl ? margin : '', 'margin-right': rtl ? '' : margin
            };
    ...
    Owl.prototype.trigger = function (name, data, namespace, enter) {
        var status = {
...
;(function ($, window, document, undefined) {
    ...
    Video.Defaults = {
        video: false, videoHeight: false, videoWidth: false
    };
    ...
    Video.prototype.fetch = function (target, item) {
        ...
        this._videos[url] = {
            type: type, id: id, width: width, height: height
        };
